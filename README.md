...
**Resumen Ejecutivo** (Pagina 1): 4 tarjetas KPI (Total Sales, Total Profit, Profit Margin %, YoY Growth %) y tendencia de ventas por region y por mes. Tema oscuro ejecutivo.

![Dashboard - Resumen Ejecutivo](dashboard-resumen-ejecutivo.png)

**Product / Region Detail** (Pagina 2): tabla operativa con slicers de Region, Category y Store, con ventas, utilidad y margen por producto y region.

![Dashboard - Product Region Detail](dashboard-product-region.png)

**Analisis de Categorias** (Pagina 3): ranking de categorias por ventas, participacion del total y crecimiento mes a mes (MoM Growth %), con formato condicional rojo/verde para identificar categorias en caida o en crecimiento de un vistazo.

![Dashboard - Analisis de Categorias](dashboard-categorias.png)
